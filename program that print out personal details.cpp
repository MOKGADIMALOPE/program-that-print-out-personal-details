// program that print out personal details.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main () {
	...
	cout << "Your natiomality is " << nationality << endl;
